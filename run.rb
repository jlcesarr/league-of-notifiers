...
WatchKill.new(adviser, "ChampionKill") && WatchKill.new(adviser, "Multikill") && WatchKill.new(adviser, "Ace") && WatchKill.new(adviser, "FirstBlood") if $cfg_notify[:notify_kill] ## CREATES AN OBSERVER TO NOTIFY WHEN ONE CHAMPION ELIMINATES ANOTHER 
